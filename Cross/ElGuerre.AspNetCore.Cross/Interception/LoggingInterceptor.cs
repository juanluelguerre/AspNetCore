...
//namespace ElGuerre.AspNetCore.Cross.Interception
//{
...
//            ((LoggingInterceptor<T>)proxy).SetParameters(decorated, logInfo, logError, serializeFunction, loggingScheduler);
...
//        private void LogException(System.Exception exception, MethodInfo methodInfo = null)
//        {
//            try
//            {
...
//                errorMessage.AppendLine(exception.Message); // GetDescription ????
